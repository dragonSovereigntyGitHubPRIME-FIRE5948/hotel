...
<html>
    ...
    <body>
        ...
        <!-- Form -->
        <form id="deleteReview" method="post" action="doDeleteReview.php">
            ...
            <div class="form-floating">
                <label readonly for="reviewForm" class="form-label">Review</label>
                <textarea required class="form-control" id="textarea_editreview" name="editReview" rows="3"><?php echo $review ?></textarea>
            </div>


            <!-- Rating -->
            <select readonly class="form-select form-select-sm" name="editRating" aria-label=".form-select-sm example">
